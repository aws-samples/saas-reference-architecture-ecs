            ...
            "Statement": [
                {
                    ...
                    "Resource": [
                        "arn:aws:dynamodb:{0}:{1}:table/EcsSaaS-TenantUserMapping".format(
                            region, aws_account_id),
                        "arn:aws:dynamodb:{0}:{1}:table/EcsSaaS-TenantDetails".format(
                            region, aws_account_id)
                    ],
                    "Condition": {
                ...
                },
                {
                    ...
                    "Resource": [
                        "arn:aws:dynamodb:{0}:{1}:table/EcsSaaS-TenantStackMapping".format(
                            region, aws_account_id),
                        "arn:aws:dynamodb:{0}:{1}:table/EcsSaaS-Settings".format(
                            region, aws_account_id)
                    ]
                }
            ]
