...
- [High Level Architecture](#high-level-architecture)
  - [SaaS Control plane and AWS SaaS Builder Toolkit (SBT)](#saas-control-plane-and-aws-saas-builder-toolkit-sbt)
  - [SaaS Application Plane](#saas-application-plane)
- [Baseline Infrastructure Provisioning](#baseline-infrastructure-provisioning)
  ...
  - [SaaS Application plane](#saas-application-plane-1)
...
- [Application Plane Architecture](#application-plane-architecture)
  ...
  - [Advanced Tier: Dedicated ECS services in a shard Cluster per tenant (Silo model)](#advanced-tier-dedicated-ecs-services-in-a-shard-cluster-per-tenant-silo-model)
...
- [Implementing Multi-tenancy in ECS SaaS](#implementing-multi-tenancy-in-ecs-saas)
  ...
  - [Implementing Storage Isolation](#implementing-storage-isolation)
    - [1. Data isolation with pooled databases](#1-data-isolation-with-pooled-databases)
    - [2. Data isolation with silo databases](#2-data-isolation-with-silo-databases)
  - [Scaling the Request Routing of the solution](#scaling-the-request-routing-of-the-solution)
    - [Nginx Routing](#nginx-routing)
    - [1. Dedicated ALBs for Premium Tier tenants](#1-dedicated-albs-for-premium-tier-tenants)
    - [2. Scaling through parallel ALBs](#2-scaling-through-parallel-albs)
...
### Tenant Onboarding
Tenant Onboarding service allows to add new tenants in the reference solution. Tenant onboarding microservice is responsible for orchestrating interactions with user management, tenant management and infrastructure provisioning (for Premium tenants) to make the new tenant ready for its users to consume.
